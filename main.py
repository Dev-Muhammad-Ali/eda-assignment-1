...
def send_message(name, email, message):
    time = datetime.now()
    print(f"[{time}] {name} ({email}): {message}")  # optional, prints to console
...
button:hover{
    background:#111 !important;  /* remove hover color change */
...
/* Remove hover effect on profile image */
...
.gradio-image {
    ...
    width: 300px !important;
    height: auto !important;
    pointer-events: none;  /* disables click/hover effect */
}
...
📧 **Email:** muhammad.ali.abid.dev@gmail.com
...
""")
                ...
                with gr.Column():
                    ...
                    submit.click(send_message, inputs=[name, email, message], outputs=output)
